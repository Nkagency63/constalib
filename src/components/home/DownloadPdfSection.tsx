        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <div className="relative">
              ...
              <input id="file-upload-section" type="file" accept=".pdf" className="hidden" onChange={handleUploadConstat} disabled={isUploading} />
            </div>
            
            <Button variant="secondary" size="lg" className="inline-flex items-center gap-2 w-full sm:w-auto" onClick={handleDownloadConstat}>
